...
export const Navbar: FunctionComponent<TProps> = ({
	isMobile,
}): ReactElement => {
	const [tab, setTab] = useState(0);

	return (
		<div className="fixed top-0 left-0 flex justify-between px-8 md:px-0 md:justify-around items-center w-screen mt-8 z-20">
